...
const Style = () => {
  ...
  return (
    <style jsx global>{`
      ...
      /* ================================== */
      /* 2. 顶部推荐模块(Header/Hero) 深度修复 */
      /* ================================== */
      
      /* --- 浅色模式 (Light Mode) --- */
      /* 强制将顶部容器背景改为浅色 */
      #theme-hexo .header-cover {
        background-color: #f5f5f5 !important; /* 如果希望纯白背景，可改为 white */
        color: #000 !important; 
      }
      ...
      .dark #theme-hexo .header-cover i {
        color: #fff !important;
      }
